#!/usr/bin/env python3
"""
Force 'git pull' (discard local changes) over SSH on hosts 10.5.99.1..N (user 'netcom').

Usage:
  python ssh_git_pull_force.py -n 30
"""
...
USER = "netcom"
PREFIX = "10.5.99."
REPO_PATH = "/home/netcom/blockchain-mec-federation"
# This will discard local changes and reset to remote HEAD
CMD = (
    f"cd {REPO_PATH} && "
    "git fetch origin && "
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Force git pull (discard changes) on 10.5.99.1..N")
