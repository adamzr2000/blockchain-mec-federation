...
HOSTS: List[Dict[str, Any]] = [
    ...
    {"role": "provider", "node_id": 21, "ip": "10.5.99.21", "iface": "eth0"},
    {"role": "provider", "node_id": 22, "ip": "10.5.99.22", "iface": "eth0"},
    {"role": "provider", "node_id": 23, "ip": "10.5.99.23", "iface": "eth0"},
    {"role": "provider", "node_id": 24, "ip": "10.5.99.24", "iface": "eth0"},
    {"role": "provider", "node_id": 25, "ip": "10.5.99.25", "iface": "eth0"},
    {"role": "provider", "node_id": 26, "ip": "10.5.99.26", "iface": "eth0"},
    {"role": "provider", "node_id": 27, "ip": "10.5.99.27", "iface": "eth0"},
    {"role": "provider", "node_id": 28, "ip": "10.5.99.28", "iface": "eth0"},
    {"role": "provider", "node_id": 29, "ip": "10.5.99.29", "iface": "eth0"},
    {"role": "provider", "node_id": 30, "ip": "10.5.99.30", "iface": "eth0"},
]
