...
# Usage: ./generate_compose.sh <NUM_VALIDATORS>
# Example: ./generate_compose.sh 10

NUM_VALIDATORS=$1
if [[ -z "$NUM_VALIDATORS" ]]; then
  echo "❌ Please provide number of validators."
  echo "   Example: ./generate_compose.sh 10"
  exit 1
fi
...
echo "✅ Done. docker-compose.yml regenerated at $OUTFILE"
